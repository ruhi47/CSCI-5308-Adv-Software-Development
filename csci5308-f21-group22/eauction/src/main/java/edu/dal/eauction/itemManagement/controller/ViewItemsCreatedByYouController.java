...
@Controller
public class ViewItemsCreatedByYouController {
	
	private static final Logger LOG = LogManager.getLogger();
	
	@RequestMapping(value = { "/viewItemsCreatedByYou" })
	public String getAllItemsCreatedByYou(@ModelAttribute(name="getItems") Item getItems,Model model) {
		LOG.info("Viewing All Items Created By You");
		...
		List<Item> itemList = itemDaoImplement.createdByUser(userID);
